...
/*
Ok, so here is how I made these certificates using my browser Safari and
	console command.
	...
	8. Content of .crt is one we interrested

	NB: all these certs are time limited, so don't forget to renew it

	Task: find the idea how to renew it in safe way on working process
*/

const char* crtR3 PROGMEM = \
    "-----BEGIN CERTIFICATE-----\n" \
